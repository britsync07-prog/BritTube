      ...
      >
        ...
        >
          <div className="text-center">
            <p className="text-[8px] font-bold text-purple-400 uppercase tracking-widest mb-1">View</p>
...
export default function ScrollMorphHero() {
  ...
  return (
    <div ref={containerRef} className="relative w-full h-full bg-[#07070a] overflow-hidden">
      <div className="flex h-full w-full flex-col items-center justify-center" style={{ perspective: "1000px" }}>
        ...
        <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2">
          ...
          <motion.p
            ...
            className="mt-4 text-xs font-bold tracking-[0.2em] text-purple-400"
          >
            SCROLL TO EXPLORE
          </motion.p>
        </div>
